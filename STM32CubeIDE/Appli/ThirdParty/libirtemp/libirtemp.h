...
#define TAU_DIST_MAX  50.0f
#define TAU_DIST_MIN  0.25f


#define TARGET_TEMP_MIN  248.15f   //kilven temperature
#define TARGET_TEMP_MAX  1623.15f  //kilven temperature
/**
 ...
 * @return see irtemp_error_t
 */
irtemp_error_t find_start_and_end_addr(const uint16_t* kt_array, const SearchInfo_t* search_info, uint16_t len, KtInfo_t* kt_info);
 ...
 * @return see irtemp_error_t
 */
irtemp_error_t read_tau(const uint16_t* correct_table, float hum, float t_env, float dist, uint16_t* tau);
 ...
 * @return see irtemp_error_t
 */
irtemp_error_t write_tau(uint16_t* correct_table, float hum , float t_env, float dist, uint16_t tau);
 ...
 * @return see irtemp_error_t
 */
irtemp_error_t  read_tau_with_target_temp_and_dist(const uint16_t* correct_table, \
 ...
 * @return see irtemp_error_t
 */
irtemp_error_t  write_tau_with_target_temp_and_dist(uint16_t* correct_table, \
	float target_temp, float dist, uint16_t tau);
 ...
 * @return see irtemp_error_t
 */
irtemp_error_t reverse_temp_correct(float ems, uint16_t tau, float ta, float new_temp, float* org_temp);
 ...
 * @return see irtemp_error_t
 */
irtemp_error_t generate_high_gain_nuc_t(NucFactor_t* nuc_factor, uint16_t* nuc_table);
 ...
 * @return see irtemp_error_t
 */
irtemp_error_t generate_low_gain_nuc_t(NucFactor_t* nuc_factor, uint16_t* nuc_table);
 ...
 * @return see irtemp_error_t
 */
irtemp_error_t reverse_calc_NUC_with_nuc_t(const uint16_t* nuc_table, float temp, uint16_t* nuc_value);
...
* @return see irtemp_error_t
*/
irtemp_error_t calculate_org_KE_and_BE_with_nuc_t(const EnvParam_t* env_param, const uint16_t* nuc_table, \
	uint8_t gain_flag, EnvFactor_t* env_factor);
...
* @return see irtemp_error_t
*/
irtemp_error_t calculate_new_KE_and_BE_with_nuc_t(const EnvParam_t* env_param, const uint16_t* nuc_table, \
	uint8_t gain_flag, EnvFactor_t* env_factor);
