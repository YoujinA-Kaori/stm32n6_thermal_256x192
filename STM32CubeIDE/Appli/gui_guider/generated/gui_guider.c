...
void init_scr_del_flag(lv_ui *ui)
{
    ...
    ui->WidgetsDemo_fullscreen_del = true;
}
...
void setup_ui(lv_ui *ui)
{
    ...
    setup_scr_WidgetsDemoFullscreen(ui);
...
void init_keyboard(lv_ui *ui)
{
    ...
    lv_obj_set_style_text_font(ui->g_kb_top_layer, &lv_font_thermal_cn_18, LV_PART_MAIN|LV_STATE_DEFAULT);
}
