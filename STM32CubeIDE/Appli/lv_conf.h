...
#define MY_DISP_HOR_RES    800  // 水平分辨率（宽度）
#define MY_DISP_VER_RES    480  // 垂直分辨率（高度）
...
#if LV_TICK_CUSTOM
    #define LV_TICK_CUSTOM_INCLUDE "stm32n6xx_hal.h"         /*Header for the system time function*/
...
#define LV_USE_GPU_STM32_DMA2D 0
    ...
    #define LV_GPU_DMA2D_CMSIS_INCLUDE "stm32n6xx.h"
#endif
