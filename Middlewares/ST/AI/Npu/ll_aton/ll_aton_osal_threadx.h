...
#define APP_HAS_PARALLEL_NETWORKS 0 // this application executes a single neural network at a time
#warning Using default value `0` for macro `APP_HAS_PARALLEL_NETWORKS`.
