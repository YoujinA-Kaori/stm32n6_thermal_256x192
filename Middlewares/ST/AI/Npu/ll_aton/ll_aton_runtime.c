...
volatile uint8_t g_ll_aton_rt_irq_err_latched = 0U;
volatile uint32_t g_ll_aton_rt_irq_err_irqs_low32 = 0U;
volatile uint32_t g_ll_aton_rt_irq_err_busif_or = 0U;
volatile uint32_t g_ll_aton_rt_irq_err_epoch_irq = 0U;
volatile uint32_t g_ll_aton_rt_irq_err_epoch_bc = 0U;
volatile uint32_t g_ll_aton_rt_irq_err_epoch_label = 0U;
#ifndef NDEBUG
...
{
  g_ll_aton_rt_irq_err_latched = 0U;
  g_ll_aton_rt_irq_err_irqs_low32 = 0U;
  g_ll_aton_rt_irq_err_busif_or = 0U;
  g_ll_aton_rt_irq_err_epoch_irq = 0U;
  g_ll_aton_rt_irq_err_epoch_bc = 0U;
  g_ll_aton_rt_irq_err_epoch_label = 0U;
}
...
#endif //(ATON_INT_NR <= 32)
{
  ...
  g_ll_aton_rt_irq_err_latched = 1U;
  g_ll_aton_rt_irq_err_irqs_low32 = (uint32_t)irqs;
  g_ll_aton_rt_irq_err_busif_or = 0U;
  g_ll_aton_rt_irq_err_epoch_irq = 0U;
  g_ll_aton_rt_irq_err_epoch_bc = 0U;
  g_ll_aton_rt_irq_err_epoch_label = 0U;
  ...
  if (irqs & ATON_INT_GET_MASK(ATON_BUSIF_INT_MASK, ATON_BUSIF_NUM))
  {
    ...
    {
      g_ll_aton_rt_irq_err_busif_or |= ATON_BUSIF_ERR_GET(i);
  ...
  {
    g_ll_aton_rt_irq_err_epoch_irq = ATON_EPOCHCTRL_IRQ_GET(0);
    g_ll_aton_rt_irq_err_epoch_bc = ATON_EPOCHCTRL_BC_GET(0);
    g_ll_aton_rt_irq_err_epoch_label = ATON_EPOCHCTRL_LABEL_GET(0);
